...
@Component({
  selector: 'app-setbenchform',
  templateUrl: './setbenchform.component.html',
  styleUrls: ['./setbenchform.component.css']
})
export class SetbenchformComponent implements OnInit {
  ...
  this.setBenchForm = this.fb.group({
    ...
    endDate: [null,],
    details: ['string',[Validators.required]],
