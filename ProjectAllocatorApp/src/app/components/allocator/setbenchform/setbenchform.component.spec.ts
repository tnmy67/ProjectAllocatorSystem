...
import { SetbenchformComponent } from './setbenchform.component';
...
describe('SetbenchformComponent', () => {
  let component: SetbenchformComponent;
  let fixture: ComponentFixture<SetbenchformComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [SetbenchformComponent],
    ...
    fixture = TestBed.createComponent(SetbenchformComponent);
  ...
  // it('should add allocation successfully and nevigate to allocator list',()=>{
  //   //Arrange
  ...
  //   component.setBenchForm.setValue(mockAllocation)
  //   const mockResponse: ApiResponse<string> = { success: true, data: '', message: 'Allocation added successfully' };

  //   allocationSpy.addAllocation.and.returnValue(of(mockResponse));
  //   allocationSpy.updateEmployee.and.returnValue(of(mockResponse));
  //   //Act
  ...
  //   //Assert
  //   expect(allocationSpy.addAllocation).toHaveBeenCalledWith(mockAllocation);
  //   //expect(router.navigate).toHaveBeenCalledWith(allocationSpy.updateEmployee);
  ...
  //   allocationSpy.addAllocation.and.returnValue(throwError(mockError));
